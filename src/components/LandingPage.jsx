  ...
  return (
    <div className="bg-white min-h-screen font-poppins relative">
      <main className="container mx-auto px-4 py-4 sm:py-8">
        ...
        >
          <div className="flex flex-col-reverse md:flex-row justify-between items-center p-4 sm:p-6 select-none">
        ...
        {loading && products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 select-none">
